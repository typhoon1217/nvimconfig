...
-- Go to previous tab (Ctrl + Left Arrow)
vim.keymap.set("n", "<C-Left>", "<cmd>tabprevious<CR>", { desc = "General | Go to previous tab", silent = true })

-- Go to next tab (Ctrl + Right Arrow)
vim.keymap.set("n", "<C-Right>", "<cmd>tabnext<CR>", { desc = "General | Go to next tab", silent = true })

-- New tab (Ctrl + Up Arrow)
vim.keymap.set("n", "<C-Up>", "<cmd>tabnew<CR>", { desc = "General | New tab", silent = true })

-- Close tab (Ctrl + Down Arrow)
vim.keymap.set("n", "<C-Down>", "<cmd>tabclose<CR>", { desc = "General | Close tab", silent = true })
...
vim.keymap.set("n", "<leader>Wv", "<cmd>vsplit<cr>", { desc = "Window | Vertical Split", silent = true })
