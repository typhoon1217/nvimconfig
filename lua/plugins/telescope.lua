...
return {
  ...
  init = function()
    ...
    vim.keymap.set("n", "<leader><leader>", "<cmd>Telescope find_files<cr>", { desc = "Telescope | Files", silent = true })
    ...
    vim.keymap.set("n", "<leader>/", "<cmd>Telescope live_grep<cr>", { desc = "Telescope | Word", silent = true })
